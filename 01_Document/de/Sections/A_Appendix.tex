...
\texttt{'01\_Manuscript'}. Die \linebreak
EndNote- oder BibTeX-Literaturreferenzen befinden sich in \texttt{'06\_References'}. Beide, die \linebreak
EndNote-Datei '*.enl' oder die BibTeX-Datei '*.bib', sollten Links zwischen den Referenzen und den
  ...
  \item \textbf{Ressourcen und Verantwortlichkeiten}
        \begin{itemize}
          ...
          \item Erforderliche personelle Ressourcen für eine erfolgreiche
                Implementierung bzw. Realisierung?
...
ELN   & $\ldots$  & Electronic Laboratory Notebook \\
